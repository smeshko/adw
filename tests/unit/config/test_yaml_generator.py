...
def _cfg(
    ...
    """Build the wizard's answers (keyed by section) for the generator."""
...
class TestYAMLWithComments:
    ...
    def test_generate_project_yaml_header(self, generator: YAMLWithComments) -> None:
        ...
        cfg = _cfg()
        yaml_content = generator.generate_project_yaml(cfg)
...
class TestYAMLGeneratorRetry:
    ...
    def test_retry_defaults_are_commented_and_round_trip(self) -> None:
        ...
        yaml_content = YAMLWithComments(ConfigRegistry()).generate_project_yaml(_cfg())
...
class TestGitFieldEmission:
    ...
    def test_skip_hooks_true_emitted_active(self, generator: YAMLWithComments) -> None:
        ...
        cfg = _cfg({"git": {"git_branch_prefix": "feature/", "git_skip_hooks": True}})
        yaml_content = generator.generate_project_yaml(cfg)
    ...
    def test_skip_hooks_false_emitted_as_comment(
        ...
        cfg = _cfg({"git": {"git_branch_prefix": "feature/", "git_skip_hooks": False}})
        yaml_content = generator.generate_project_yaml(cfg)
    ...
    def test_base_branch_none_emitted_as_comment(
        ...
        cfg = _cfg({"git": {"git_branch_prefix": "feature/", "git_base_branch": None}})
        yaml_content = generator.generate_project_yaml(cfg)
...
class TestTaskManagerFieldEmission:
    ...
    def test_auto_close_not_emitted(
        ...
        cfg = _cfg({"task_manager": task_manager})
        yaml_content = generator.generate_project_yaml(cfg)
    ...
    def test_default_state_mapping_emitted_as_comment(
        ...
        cfg = _cfg({"task_manager": {"enabled": True, "type": "linear"}})
        yaml_content = generator.generate_project_yaml(cfg)
